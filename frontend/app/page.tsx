      ...
      <main className="mx-auto flex w-full max-w-5xl flex-col px-4 py-16 sm:px-6 sm:py-24">
        ...
        <div className="mt-20 grid gap-6 sm:grid-cols-3">
          ...
          <FeatureCard
            ...
            title="Clean Notes"
            description="Exportable transcripts designed for quick review and sharing."
          />
          <FeatureCard
        ...
        <div className="mt-20">
          <div className="flex flex-col gap-4 rounded-2xl border border-[#E5E7EB] bg-[#F9FAFB] p-8 text-center sm:p-12">
            ...
            <div className="mt-4 flex justify-center">
              <Link href="/pricing" className="text-sm font-semibold text-[#3454F5] hover:underline flex items-center">
